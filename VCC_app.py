...
def vapor_compression_cycle_points(refrigerant, evap_temp=T_Evap, cond_temp=T_Cond, subcooling=Subcool, superheat=Superheat):
    ...
    Compressor_Temperature_out_est = PropsSI('T','P',cond_pressure,'S',Compressor_Entropy_out*1000,refrigerant)

    H_Comp_out = PropsSI('H','T',Compressor_Temperature_out_est,'P',cond_pressure,refrigerant)

    H_Cond_out = PropsSI('H','T',T_Cond_K - Subcool,'P',cond_pressure,refrigerant)
