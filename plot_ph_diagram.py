...
def plot_ph_diagram(refrigerant):
    ...
    plt.plot([points[0][0], points[1][0]], [points[0][1], points[1][1]], 'ro-', label="Compression")
    plt.plot([points[1][0], points[2][0]], [points[1][1], points[2][1]], 'go-', label="Condensation")
    plt.plot([points[2][0], points[3][0]], [points[2][1], points[3][1]], 'bo-', label="Expansion")
    plt.plot([points[3][0], points[0][0]], [points[3][1], points[0][1]], 'yo-', label="Evaporation")
